...
vpath %.asm $(vpath_src)
vpath %.nsm $(vpath_src)
vpath_header=$(TVISION_INC) ../easydiag ../settvuti/include ../include
...
INCLUDE_DIRS=$(TVISION_INC) ../easydiag ../settvuti/include ../include
LIB_DIRS=$(RHIDE_OS_LIBS_PATH) . ../settvuti
C_DEBUG_FLAGS=
C_OPT_FLAGS=
C_WARN_FLAGS=
C_C_LANG_FLAGS=
...
ALL_OBJFILES=obj/lablchek.o obj/lablradi.o obj/snostate.o obj/tcheck2.o\
	...
	obj/ttextscr.o obj/test.o
LIBRARIES=easydiag.a libsettv.a
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
SPECIAL_LDFLAGS=
...
PROJECT_ITEMS=easydiag.gpr libsettv.a test.cc
DEFAULT_MASK=*
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= obj/test.o easydiag.a libsettv.a
NO_LINK=
...
DEPS_2=test.cc ../../tvision/include/tv.h ../../tvision/include/tv/app.h\
	...
	../easydiag/tslider.h ../easydiag/tslistbo.h ../easydiag/tsradbot.h\
	../easydiag/tssortlb.h ../easydiag/tssortva.h\
	../easydiag/tstatext.h ../easydiag/tstextsc.h ../easydiag/tsvegrp.h\
