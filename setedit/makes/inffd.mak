...
# gpr2mak inffd.gpr
vpath_src=../infview ../infview/streams ../infview/names
vpath %.c $(vpath_src)
vpath %.cc $(vpath_src)
vpath %.cpp $(vpath_src)
vpath %.C $(vpath_src)
...
vpath %.asm $(vpath_src)
vpath %.nsm $(vpath_src)
vpath_header=../infview/include ../include ../settvuti/include\
...
OBJFILES=obj/inf.o obj/infbase.o obj/manview.o obj/nhiscoll.o\
	obj/ninfview.o obj/ninfwind.o obj/nmanwind.o obj/sinf.o obj/sman.o
ALL_OBJFILES=obj/inf.o obj/infbase.o obj/manview.o obj/nhiscoll.o\
	obj/ninfview.o obj/ninfwind.o obj/nmanwind.o obj/sinf.o obj/sman.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
...
SPECIAL_LDFLAGS=
PROG_ARGS=
SRC_DIRS=../infview ../infview/streams ../infview/names
WUC=
EDITORS=
MAIN_TARGET=
PROJECT_ITEMS=inf.cc infbase.cc manview.cc nhiscoll.cc ninfview.cc\
	ninfwind.cc nmanwind.cc sinf.cc sman.cc
DEFAULT_MASK=*
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= obj/inf.o obj/infbase.o obj/manview.o obj/nhiscoll.o obj/ninfview.o\
	obj/ninfwind.o obj/nmanwind.o obj/sinf.o obj/sman.o 
NO_LINK=
LINK_FILES=$(filter-out $(NO_LINK),$(DEPS_0))
TARGET_0:: $(DEPS_0)
DEPS_1=inf.cc ../extra/dyncat.h ../include/ced_coma.h ../include/ced_exte.h\
...
obj/inf.o:: $(DEPS_1)
	$(RHIDE_COMPILE.cc.o)
DEPS_2=infbase.cc ../extra/dyncat.h ../include/ceditint.h\
...
obj/infbase.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cc.o)
DEPS_3=manview.cc ../easydiag/easydia1.h ../easydiag/easydiag.h\
	...
	../../tvision/include/tv/window.h\
	../../tvision/include/tv/yes_mss.h
obj/manview.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cc.o)
DEPS_4=nhiscoll.cc ../settvuti/include/settvuti.h\
	../../tvision/include/compatlayer.h ../../tvision/include/tv.h\
...
obj/nhiscoll.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cc.o)
DEPS_5=ninfview.cc ../settvuti/include/settvuti.h\
	../../tvision/include/compatlayer.h ../../tvision/include/tv.h\
	../../tvision/include/tv/configtv.h ../../tvision/include/tv/intl.h\
	../../tvision/include/tv/ipstream.h\
	../../tvision/include/tv/opstream.h\
	...
	../../tvision/include/tv/tvconfig.h\
	../../tvision/include/tv/tvutil.h ../../tvision/include/tv/views.h
obj/ninfview.o:: $(DEPS_5)
	$(RHIDE_COMPILE.cc.o)
DEPS_6=ninfwind.cc ../settvuti/include/settvuti.h\
	../../tvision/include/compatlayer.h ../../tvision/include/tv.h\
	../../tvision/include/tv/configtv.h ../../tvision/include/tv/intl.h\
	../../tvision/include/tv/ipstream.h\
	../../tvision/include/tv/opstream.h\
	...
	../../tvision/include/tv/tvconfig.h\
	../../tvision/include/tv/tvutil.h ../../tvision/include/tv/views.h
obj/ninfwind.o:: $(DEPS_6)
	$(RHIDE_COMPILE.cc.o)
DEPS_7=nmanwind.cc ../settvuti/include/settvuti.h\
	../../tvision/include/compatlayer.h ../../tvision/include/tv.h\
	../../tvision/include/tv/configtv.h ../../tvision/include/tv/intl.h\
	../../tvision/include/tv/ipstream.h\
	../../tvision/include/tv/opstream.h\
	...
	../../tvision/include/tv/tvconfig.h\
	../../tvision/include/tv/tvutil.h ../../tvision/include/tv/views.h
obj/nmanwind.o:: $(DEPS_7)
	$(RHIDE_COMPILE.cc.o)
DEPS_8=sinf.cc ../include/tvsetuti.h ../infview/include/inf.h\
	../infview/include/infbase.h ../infview/include/infbaser.h\
...
obj/sinf.o:: $(DEPS_8)
	$(RHIDE_COMPILE.cc.o)
DEPS_9=sman.cc ../include/tvsetuti.h ../infview/include/manview.h\
	../../tvision/include/compatlayer.h ../../tvision/include/tv.h\
	../../tvision/include/tv/configtv.h\
