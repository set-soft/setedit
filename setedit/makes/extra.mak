...
vpath %.asm $(vpath_src)
vpath %.nsm $(vpath_src)
vpath_header=../extra ../include $(TVISION_INC)
...
INCLUDE_DIRS=../extra ../include $(TVISION_INC)
LIB_DIRS=
C_DEBUG_FLAGS=
C_OPT_FLAGS=
C_WARN_FLAGS=
...
OBJFILES=obj/djmdr.o obj/dyncat.o obj/memmove.o obj/mixer.o obj/mixersb.o\
	obj/mixoss.o obj/stackdbg.o obj/strncpyz.o obj/strndup.o\
	obj/winoldap.o
ALL_OBJFILES=obj/djmdr.o obj/dyncat.o obj/memmove.o obj/mixer.o\
	obj/mixersb.o obj/mixoss.o obj/stackdbg.o obj/strncpyz.o\
	obj/strndup.o obj/winoldap.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
...
EDITORS=
MAIN_TARGET=
PROJECT_ITEMS=djmdr.s dyncat.cc memmove.s mixer.c mixersb.c mixoss.c\
	stackdbg.c strncpyz.cc strndup.cc winoldap.cc
DEFAULT_MASK=*.[chmps]*
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= obj/djmdr.o obj/dyncat.o obj/memmove.o obj/mixer.o obj/mixersb.o\
	obj/mixoss.o obj/stackdbg.o obj/strncpyz.o obj/strndup.o\
	obj/winoldap.o 
NO_LINK=
...
LOCAL_1=\
	djmdr.s___-x\
	djmdr.s___assembler-with-cpp
LOCAL_OPTIONS += $(LOCAL_1)
DEPS_2=dyncat.cc ../extra/dyncat.h
obj/dyncat.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cc.o)
DEPS_3=memmove.s
obj/memmove.o:: $(DEPS_3)
	$(RHIDE_COMPILE_ASM_FORCE)
LOCAL_3=\
	memmove.s___-x\
	memmove.s___assembler-with-cpp
LOCAL_OPTIONS += $(LOCAL_3)
DEPS_4=mixer.c ../extra/mixer.h ../include/configed.h
obj/mixer.o:: $(DEPS_4)
	$(RHIDE_COMPILE.c.o)
DEPS_5=mixersb.c ../include/configed.h
obj/mixersb.o:: $(DEPS_5)
	$(RHIDE_COMPILE.c.o)
DEPS_6=mixoss.c ../extra/mixer.h ../include/configed.h
obj/mixoss.o:: $(DEPS_6)
	$(RHIDE_COMPILE.c.o)
DEPS_7=stackdbg.c ../../tvision/include/compatlayer.h\
	../../tvision/include/tv/configtv.h ../extra/stackdbg.h\
	../include/configed.h
obj/stackdbg.o:: $(DEPS_7)
	$(RHIDE_COMPILE.c.o)
DEPS_8=strncpyz.cc
obj/strncpyz.o:: $(DEPS_8)
	$(RHIDE_COMPILE.cc.o)
DEPS_9=strndup.cc
obj/strndup.o:: $(DEPS_9)
	$(RHIDE_COMPILE.cc.o)
DEPS_10=winoldap.cc ../include/configed.h
obj/winoldap.o:: $(DEPS_10)
	$(RHIDE_COMPILE.cc.o)
all:: TARGET_0
