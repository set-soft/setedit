...
vpath %.asm $(vpath_src)
vpath %.nsm $(vpath_src)
vpath_header=../settvuti/include $(TVISION_INC) $(SUPPORT_INC) ../easydiag\
	../include
...
ALL_OBJFILES=obj/datafile.o obj/lablchek.o obj/lablradi.o obj/snostate.o\
	...
	obj/tsviewco.o obj/ttextscr.o obj/install.o obj/nostatex.o\
	obj/nprogbar.o obj/nprogres.o obj/tprogbar.o obj/tprogdia.o\
	obj/tprogres.o
