...
vpath %.asm $(vpath_src)
vpath %.nsm $(vpath_src)
vpath_header=../librhuti $(TVISION_INC)
...
INCLUDE_DIRS=../librhuti $(TVISION_INC)
LIB_DIRS=
C_DEBUG_FLAGS=
C_OPT_FLAGS=
C_WARN_FLAGS=
...
OBJFILES=obj/abstorel.o obj/back2sl.o obj/basename.o obj/fexpand.o obj/io.o\
	obj/specs.o obj/splitfn.o obj/stricat.o obj/stridown.o\
	obj/stridup.o obj/strifree.o
ALL_OBJFILES=obj/abstorel.o obj/back2sl.o obj/basename.o obj/fexpand.o\
	obj/io.o obj/specs.o obj/splitfn.o obj/stricat.o obj/stridown.o\
	obj/stridup.o obj/strifree.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
...
PROJECT_ITEMS=abstorel.cc back2sl.cc basename.cc fexpand.cc io.cc specs.cc\
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= obj/abstorel.o obj/back2sl.o obj/basename.o obj/fexpand.o obj/io.o\
	obj/specs.o obj/splitfn.o obj/stricat.o obj/stridown.o\
	obj/stridup.o obj/strifree.o 
NO_LINK=
...
DEPS_1=abstorel.cc ../librhuti/rhutils.h
obj/abstorel.o:: $(DEPS_1)
	$(RHIDE_COMPILE.cc.o)
DEPS_2=back2sl.cc ../librhuti/rhutils.h
obj/back2sl.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cc.o)
...
obj/fexpand.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cc.o)
DEPS_5=io.cc ../librhuti/rhutils.h ../../tvision/include/compatlayer.h\
	../../tvision/include/tv/configtv.h
obj/io.o:: $(DEPS_5)
	$(RHIDE_COMPILE.cc.o)
...
obj/splitfn.o:: $(DEPS_7)
	$(RHIDE_COMPILE.cc.o)
DEPS_8=stricat.cc ../librhuti/rhutils.h
obj/stricat.o:: $(DEPS_8)
	$(RHIDE_COMPILE.cc.o)
DEPS_9=stridown.cc ../librhuti/rhutils.h
obj/stridown.o:: $(DEPS_9)
	$(RHIDE_COMPILE.cc.o)
DEPS_10=stridup.cc ../librhuti/rhutils.h
obj/stridup.o:: $(DEPS_10)
	$(RHIDE_COMPILE.cc.o)
DEPS_11=strifree.cc ../librhuti/rhutils.h
obj/strifree.o:: $(DEPS_11)
	$(RHIDE_COMPILE.cc.o)
all:: librhuti.a
