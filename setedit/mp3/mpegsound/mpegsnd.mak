...
# gpr2mak ../mp3/mpegsound/mpegsnd.gpr
...
OBJFILES=obj/bitwindow.o obj/fileinput.o obj/fileplayer.o obj/filter.o\
	obj/filter_2.o obj/httpinput.o obj/huffmantable.o obj/mpegtable.o\
	obj/mpegtoraw.o obj/mpegwtoraw.o obj/mpglayr1.o obj/mpglayr2.o\
	obj/mpglayr3.o obj/osdisk.o obj/rawplayer.o obj/rawtofile.o\
	obj/rawtowav.o obj/soundinputstream.o obj/soundplayer.o\
	obj/wavetoraw.o
ALL_OBJFILES=obj/bitwindow.o obj/fileinput.o obj/fileplayer.o obj/filter.o\
	obj/filter_2.o obj/httpinput.o obj/huffmantable.o obj/mpegtable.o\
	obj/mpegtoraw.o obj/mpegwtoraw.o obj/mpglayr1.o obj/mpglayr2.o\
	obj/mpglayr3.o obj/osdisk.o obj/rawplayer.o obj/rawtofile.o\
	obj/rawtowav.o obj/soundinputstream.o obj/soundplayer.o\
...
WUC=
EDITORS=
MAIN_TARGET=../../makes/libmpegsnd.a
PROJECT_ITEMS=bitwindow.cc fileinput.cc fileplayer.cc filter.cc filter_2.cc\
	httpinput.cc huffmantable.cc mpegtable.cc mpegtoraw.cc\
	mpegwtoraw.cc mpglayr1.cc mpglayr2.cc mpglayr3.cc osdisk.cc\
	rawplayer.cc rawtofile.cc rawtowav.cc soundinputstream.cc\
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= obj/bitwindow.o obj/fileinput.o obj/fileplayer.o obj/filter.o\
	obj/filter_2.o obj/httpinput.o obj/huffmantable.o obj/mpegtable.o\
	obj/mpegtoraw.o obj/mpegwtoraw.o obj/mpglayr1.o obj/mpglayr2.o\
	obj/mpglayr3.o obj/osdisk.o obj/rawplayer.o obj/rawtofile.o\
	obj/rawtowav.o obj/soundinputstream.o obj/soundplayer.o\
...
../../makes/libmpegsnd.a:: $(DEPS_0)
	$(RHIDE_COMPILE_ARCHIVE)
DEPS_1=bitwindow.cc ../../include/configed.h mpegsound.h
obj/bitwindow.o:: $(DEPS_1)
	$(RHIDE_COMPILE.cc.o)
DEPS_2=fileinput.cc ../../include/configed.h mpegsound.h
obj/fileinput.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cc.o)
DEPS_3=fileplayer.cc ../../include/configed.h mpegsound.h
obj/fileplayer.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cc.o)
DEPS_4=filter.cc ../../include/configed.h mpegsound.h
obj/filter.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cc.o)
DEPS_5=filter_2.cc ../../include/configed.h mpegsound.h
obj/filter_2.o:: $(DEPS_5)
	$(RHIDE_COMPILE.cc.o)
DEPS_6=httpinput.cc
obj/httpinput.o:: $(DEPS_6)
	$(RHIDE_COMPILE.cc.o)
DEPS_7=huffmantable.cc ../../include/configed.h mpegsound.h
obj/huffmantable.o:: $(DEPS_7)
	$(RHIDE_COMPILE.cc.o)
DEPS_8=mpegtable.cc ../../include/configed.h mpegsound.h
obj/mpegtable.o:: $(DEPS_8)
	$(RHIDE_COMPILE.cc.o)
DEPS_9=mpegtoraw.cc ../../include/configed.h mpegsound.h mpg_locals.h
obj/mpegtoraw.o:: $(DEPS_9)
	$(RHIDE_COMPILE.cc.o)
DEPS_10=mpegwtoraw.cc ../../include/configed.h mpegsound.h
obj/mpegwtoraw.o:: $(DEPS_10)
	$(RHIDE_COMPILE.cc.o)
DEPS_11=mpglayr1.cc ../../include/configed.h mpegsound.h
obj/mpglayr1.o:: $(DEPS_11)
	$(RHIDE_COMPILE.cc.o)
DEPS_12=mpglayr2.cc ../../include/configed.h mpegsound.h
obj/mpglayr2.o:: $(DEPS_12)
	$(RHIDE_COMPILE.cc.o)
DEPS_13=mpglayr3.cc ../../include/configed.h mpegsound.h mpg_locals.h
obj/mpglayr3.o:: $(DEPS_13)
	$(RHIDE_COMPILE.cc.o)
DEPS_14=osdisk.cc ../../include/configed.h mpegsound.h
obj/osdisk.o:: $(DEPS_14)
	$(RHIDE_COMPILE.cc.o)
DEPS_15=rawplayer.cc ../../include/configed.h mpegsound.h
obj/rawplayer.o:: $(DEPS_15)
	$(RHIDE_COMPILE.cc.o)
DEPS_16=rawtofile.cc ../../include/configed.h mpegsound.h
obj/rawtofile.o:: $(DEPS_16)
	$(RHIDE_COMPILE.cc.o)
DEPS_17=rawtowav.cc ../../include/configed.h mpegsound.h
obj/rawtowav.o:: $(DEPS_17)
	$(RHIDE_COMPILE.cc.o)
DEPS_18=soundinputstream.cc ../../include/configed.h mpegsound.h
obj/soundinputstream.o:: $(DEPS_18)
	$(RHIDE_COMPILE.cc.o)
DEPS_19=soundplayer.cc ../../include/configed.h mpegsound.h
obj/soundplayer.o:: $(DEPS_19)
	$(RHIDE_COMPILE.cc.o)
DEPS_20=wavetoraw.cc ../../include/configed.h mpegsound.h
obj/wavetoraw.o:: $(DEPS_20)
	$(RHIDE_COMPILE.cc.o)
all:: ../../makes/libmpegsnd.a
