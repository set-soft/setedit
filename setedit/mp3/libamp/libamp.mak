...
RHIDE_OS_LIBS_PATH=../../tvision-head/linuxso  /usr/X11R6/lib
...
LIBS=alleg m
LD_EXTRA_FLAGS=
C_EXTRA_FLAGS=-DNO_BYTE_SWAPPING -DOS_MSDOS
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=obj/audioalg.o obj/audiolib.o obj/dump.o obj/formats.o\
	obj/getbits.o obj/getdata.o obj/guicontr.o obj/huffman.o\
	obj/layer2.o obj/layer3.o obj/misc2.o obj/position.o obj/rtbuf.o\
	obj/transfor.o obj/util.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
SPECIAL_LDFLAGS=
PROG_ARGS=-nobuffer m:summer.mp3
SRC_DIRS=
WUC=
EDITORS=
RHIDE_OS=$(RHIDE_OS_)
...
MAIN_TARGET=../../makes/djgpp/libamp.a
PROJECT_ITEMS=audioalg.c audiolib.c dump.c formats.c getbits.c getdata.c\
	guicontr.c huffman.c layer2.c layer3.c misc2.c position.c rtbuf.c\
	transfor.c util.c
DEFAULT_MASK=*
...
%.s: %.C
	$(RHIDE_COMPILE.C.s)
all::
DEPS_0= obj/audioalg.o obj/audiolib.o obj/dump.o obj/formats.o\
	obj/getbits.o obj/getdata.o obj/guicontr.o obj/huffman.o\
	obj/layer2.o obj/layer3.o obj/misc2.o obj/position.o obj/rtbuf.o\
	obj/transfor.o obj/util.o 
NO_LINK=
LINK_FILES=$(filter-out $(NO_LINK),$(DEPS_0))
../../makes/djgpp/libamp.a:: $(DEPS_0)
	$(RHIDE_COMPILE_ARCHIVE)
DEPS_1=audioalg.c ../audio.h ../libamp.h amp.h audioIO.h config.h proto.h\
	transform.h
obj/audioalg.o:: $(DEPS_1)
	$(RHIDE_COMPILE.c.o)
DEPS_2=audiolib.c ../audio.h ../formats.h ../getbits.h ../libamp.h amp.h\
	config.h controldata.h guicontrol.h huffman.h layer2.h layer3.h\
	position.h proto.h rtbuf.h transform.h
obj/audiolib.o:: $(DEPS_2)
	$(RHIDE_COMPILE.c.o)
DEPS_3=dump.c ../audio.h ../getbits.h dump.h
obj/dump.o:: $(DEPS_3)
	$(RHIDE_COMPILE.c.o)
DEPS_4=formats.c ../audio.h ../formats.h
obj/formats.o:: $(DEPS_4)
	$(RHIDE_COMPILE.c.o)
DEPS_5=getbits.c ../audio.h ../formats.h ../getbits.h amp.h config.h\
	proto.h rtbuf.h
obj/getbits.o:: $(DEPS_5)
	$(RHIDE_COMPILE.c.o)
DEPS_6=getdata.c ../audio.h ../getbits.h amp.h config.h getdata.h huffman.h\
	proto.h
obj/getdata.o:: $(DEPS_6)
	$(RHIDE_COMPILE.c.o)
DEPS_7=guicontr.c
obj/guicontr.o:: $(DEPS_7)
	$(RHIDE_COMPILE.c.o)
DEPS_8=huffman.c ../audio.h ../getbits.h huffman.h
obj/huffman.o:: $(DEPS_8)
	$(RHIDE_COMPILE.c.o)
DEPS_9=layer2.c ../audio.h ../getbits.h amp.h config.h layer2.h proto.h\
	transform.h
obj/layer2.o:: $(DEPS_9)
	$(RHIDE_COMPILE.c.o)
DEPS_10=layer3.c ../audio.h ../getbits.h amp.h config.h dump.h getdata.h\
	huffman.h layer3.h misc2.h proto.h rtbuf.h transform.h
obj/layer3.o:: $(DEPS_10)
	$(RHIDE_COMPILE.c.o)
DEPS_11=misc2.c ../audio.h amp.h config.h getdata.h huffman.h misc2.h\
	proto.h
obj/misc2.o:: $(DEPS_11)
	$(RHIDE_COMPILE.c.o)
DEPS_12=position.c ../audio.h ../getbits.h amp.h config.h position.h\
	proto.h
obj/position.o:: $(DEPS_12)
	$(RHIDE_COMPILE.c.o)
DEPS_13=rtbuf.c ../audio.h ../getbits.h amp.h config.h layer3.h proto.h\
	rtbuf.h transform.h
obj/rtbuf.o:: $(DEPS_13)
	$(RHIDE_COMPILE.c.o)
DEPS_14=transfor.c ../audio.h getdata.h misc2.h transform.h
obj/transfor.o:: $(DEPS_14)
	$(RHIDE_COMPILE.c.o)
DEPS_15=util.c ../audio.h amp.h config.h proto.h
obj/util.o:: $(DEPS_15)
	$(RHIDE_COMPILE.c.o)
all:: ../../makes/djgpp/libamp.a
